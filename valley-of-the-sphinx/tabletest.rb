...
#-- to earning hints via treasure in the sphinx temple--#	
	if  @score >= 29
		...
		puts "This was merely the first phase in the first step to finding answers to things you don't even know to question."	
		to_say =  "This was merely the first phase in the first step to finding answers to things you don't even know to question."
			`say  #{to_say}`
